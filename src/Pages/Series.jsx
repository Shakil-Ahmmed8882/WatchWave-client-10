...
const Series = () => {
  ...
  const imgs =[
    ...
    'https://th.bing.com/th/id/R.93c61b8401624197cf3406a5a191f262?rik=9pRM%2fBTSt7Ntiw&pid=ImgRaw&r=0',
  ...
  return (
    <div className="bg-white series-cover">
      ...
      <div className="flex flex-1 flex-wrap py-11 flex-col-reverse md:flex-row md:h-[70vh] items-center w-full p-3 ">
        <div className="flex-1 relative space-y-4 md:ml-5 py-8  md:py-0">
          ...
          <div className="space-x-5 pt-3">
            <button className="bg-indigo-500 hover:bg-indigo-700 transition-all rounded-full text-white px-20 py-2">Play</button>
            <button className="bg-indigo-500 text-white hover:bg-indigo-700 transition-all rounded-full  px-20 py-2">Play</button>
          </div>
          <div>
        ...
        {array?.map((category, idx) => (
          <div
            ...
            <div className="overlay flex relative">
              <span className="text-3xl flex-1 mt-16 hidden brandName w-full h-full">
                {category.brand.genreName}
              </span>
              <img className="absolute top-0 bottom-0 right-0 left-0 w-16 h-16 rounded-full m-auto hidden brandName" src="https://th.bing.com/th/id/OIP.Tu-vaj5Vl1kIMetrFsuoKgHaHa?pid=ImgDet&w=500&h=500&rs=1" alt="" />
            </div>
            <img
