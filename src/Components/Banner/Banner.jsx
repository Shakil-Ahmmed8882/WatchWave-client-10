...
const Banner = () => {
  return (
      <div id="banner" className="flex dark:bg-gray-800 gap-3 flex-col-reverse md:flex-row dark:text-white text-white md:text-black  sm:text-center md:text-left banner-bg px-3 ">
      <div className="flex-1 space-y-4">
        ...
        <div className="flex flex-col md:flex-row sm:text-center md:text-left p-1 md:p-8 my-3 pt-8 md:border-2 gap-3 relative md:top-5">
          ...
          <div className="text-sm-light-text dark:text-gray-300 dark:bg-gray-800" id="description50k">
      ...
      <div className="md:grid w-full right-container hidden md:grid-cols-2 gap-3 flex-1 h-[90vh]">
        <div className=" bg-1 bg-cyan-300   rounded-xl  row-span-2">
          <div className="floating-text dark:bg-gray-900">
