        ...
        <div>
          ...
          <ul className="space-y-2">
            <li className="flex items-center">
              ...
              <p className="font-medium text-gray-800">No exclusive content.
</p>
            </li>
            <li className="flex items-center">
              <div className="mr-2">
              ...
              <p className="font-medium text-gray-800">1Ads and interruptions.
</p>
            </li>
            <li className="flex items-center">
              <div className="mr-2">
              ...
              <p className="font-medium text-gray-800">Lower video quality (e.g., no 4K).
</p>
            </li>
            <li className="flex items-center">
              <div className="mr-2">
              ...
              <p className="font-medium text-gray-800">Limited movie selection</p>
            </li>
          </ul>
        </div>
      </div>
